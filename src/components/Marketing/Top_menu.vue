	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="mobile-only-brand pull-left">
			<div id="complogo" class="nav-header pull-left">
				<div class="logo-wrap">
					<a href="#">
						<img class="brand-img" src="../assets/logo.png" alt="lg"/>
						<span class="brand-text" v-for="name in detailNama">{{name.username}}</span>
					</a>
				</div>
			</div>	
						...
						<li>
							<div class="streamline message-nicescroll-bar">
								...
								<div class="sl-item">
									<a href="javascript:void(0)">
										<div class="sl-avatar">
											<img class="img-responsive" src="../assets/user.png" alt="avatar"/>
										</div>
										<div class="sl-content">
		...
		methods:{
			logout:function(){
				this.$store.dispatch("logout").then(() =>{
					this.$router.push('/');
					this.$swal("Berhasil","Anda telah Log-out","success");
				});
			}
		},
		computed:{
			detailNama:function(){
				var a = this.$store.getters.role;
