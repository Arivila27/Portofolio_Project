                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default card-view panel-refresh">
                            ...
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">LOG_COMPLAIN</h6>
                                </div>
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="(complain,index) in DisplayedComplain" v-bind:key="complain._id">
                                            <td>{{index + 1}}</td>
                                            <td>{{complain.device}}</td>
                                            <td>{{complain.ip}}</td>
...
<script src="./Service/list_log_complain"></script>