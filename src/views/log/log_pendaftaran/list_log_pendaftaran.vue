                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default card-view panel-refresh">
                            ...
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">LOG_PENDAFTARAN</h6>
                                </div>
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="(pendaftaran,index) in DisplayedPendaftaran" v-bind:key="pendaftaran._id">
                                            <td>{{index + 1}}</td>
                                            <td>{{pendaftaran.device}}</td>
                                            <td>{{pendaftaran.ip}}</td>
                                            <td>{{pendaftaran.tanggal}}</td>
                                            <td>{{pendaftaran.log}}</td>
                                        </tr>
                                    </tbody>
                                </table>
...
<script src="./Service/list_log_pendaftaran"></script>