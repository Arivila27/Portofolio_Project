                    ...
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form-wizard @on-complete="addToApi">
                                <h4 slot="title">Registrasii Pelanggan</h4>
                                <tab-content title="Data diri" icon="ti-user">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label>Cabang</label>
                                            <multiselect v-model="pilih_cabang" :options="M_cabang" :searchable="true" :close-on-select="true" :show-labels="false" label="cabang_nama" placeholder="Pilih Cabang"></multiselect>
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="input-group mb-15">
                                                <span class="input-group-addon bg-grey2">{{pilih_cabang.cabang_kode}}</span>
                                ...
                                <tab-content title="Alamat Lengkap" icon="ti-map">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class="form-control" v-model="pilih_domain">
                                                <option v-for="(domain,k) in list_domain" :key="k">{{domain.domain_nama}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                    ...
                                    <div class="row">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <multiselect v-model="pilih_alat" :multiple="true" :options="M_alat" :searchable="true" :close-on-select="true" :show-labels="false" label="item_nama" placeholder="Pilih Cabang"></multiselect>
                                            </div>
                                        </div>
                                    </div>
                                </tab-content>
                                <tab-content title="PPOE" icon="ti-check">
                                    <div class="col-md-12">
                                        <div class="clearfix"></div>
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label>PPOE</label>
                                                <input type="email" class="form-control" v-model="M_pengguna.pengguna_ppoe">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Password</label>
                                                <input type="password" class="form-control" v-model="M_pengguna.pengguna_password">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Tanggal aktivasi</label>
                                                <input type="date" class="form-control" v-model="M_pengguna.pengguna_tanggal_pemasangan">
                                                *Dapat diaktifkan di tabel
                                            </div>
                                            <div class="form-group col-md-4">
