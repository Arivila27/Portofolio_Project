                        ...
                        <div class="col-md-12">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select v-model="M_item.item_dkepartmen" class="form-control">
                                        <option v-for="departmen in M_departmen">{{departmen.divisi_nama}}</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Show Product?</label>
                                    <select v-model="M_item.item_show" class="form-control">
                                        <option v-for="option in M_show" :value="option.value">
                                            {{ option.text }}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputname" placeholder="Nama produk" v-model="M_item.item_nama">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="hargasatuan">Harga Barang</label>
                                    <vue-numeric currency="Rp." separator="," class="form-control" id="hargasatuan" v-model="M_item.item_harga "></vue-numeric>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="">Kode Produk</label>
                                    <input type="text" class="form-control" v-model="M_item.item_kode">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label>Pilih Router</label>
                                    <multiselect v-model="pilih_router" :multiple="true" :options="M_router" :searchable="true" label="name" placeholder="Pilih Router" track-by="_id"></multiselect>
                                </div>
                            </div>
