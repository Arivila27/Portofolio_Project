...
export default {
    ...
    methods: {
        ...
        getdaatapenagihancash() {
            axios.get(this.$API + '/Tr_penagihan/Cash/' + this.$store.getters.domain)
                .then((response) => {
                    this.tr_cash = response.data
                });
        },
        getdatapenagihanbca() {
            axios.get(this.$API + '/Tr_penagihan/BCA/' + this.$store.getters.domain)
                .then((response) => {
                    this.tr_bca = response.data;
                });
        },
        getdatapenagihanmandiri() {
            axios.get(this.$API + '/Tr_penagihan/Mandiri/' + this.$store.getters.domain)
                .then((response) => {
                    this.tr_mandiri = response.data;
                });
        },
        getdatapenagihanbca371() {
            axios.get(this.$API + '/Tr_penagihan/BCA-371/' + this.$store.getters.domain)
                .then((response) => {
