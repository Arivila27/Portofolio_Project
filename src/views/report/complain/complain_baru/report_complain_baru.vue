                ...
                <div class="row">
                    <div class="panel panel-default card-view panel-refresh">
                        ...
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark">Laporan Pelanggan Complain Baru</h6>
                            </div>
    ...
    computed: {
        Filtercomplain: function() {
            return this.complain.filter((complain) => {
                var mencari_tanggal = complain.complain_created.match(this.cari_tanggal);
                var mencari_bulan = complain.complain_created.match(this.cari_bulan);
                var mencari_tahun = complain.complain_created.match(this.cari_tahun);
