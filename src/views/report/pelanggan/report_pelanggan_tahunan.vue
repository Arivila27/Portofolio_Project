                ...
                <div class="col-sm-12">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark">Laporan Pelanggan(Tahunan)</h6>
                            </div>
                                ...
                                <div class="table-wrap mt-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="year" class="form-control" v-model="select_month">
                                        </div>
                                        <div class="col-md-3">
...
<script src="./Service/report_pelanggan_tahunan"></script>
<style scoped>
table {
