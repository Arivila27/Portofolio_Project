        ...
        <div class="panel-body">
            ...
            <table class="table table-borderless">
                ...
                <tbody>
                            ...
                            <div class="pull-right">
                                <div class="dropdown  pull-left">
                                    ...
                                    <ul class="dropdown-menu bullet dropdown-menu-right" role="menu">
                                        <li role="presentation"><a href="javascript:void(0)" role="menuitem" data-toggle="modal" data-target="#hapusproses" v-on:click="hereki(kluhan._id,kluhan.complain_status,kluhan.complain_pengguna_nama)"><i class="icon wb-share" aria-hidden="true"></i>Delete</a></li>
                                        <li role="presentation"><a href="javascript:void(0)" v-on:click="detail_pelanggan(kluhan._id,kluhan.complain_pengguna_nama,kluhan.complain_pengguna_alamat,kluhan.complain_pengguna_ppoe,kluhan.complain_pengguna_keluhan,kluhan.complain_penyelesaian,kluhan.complain_yang_menangani.complain_penangan_nama,kluhan.complain_pengguna_notice)" role="menuitem" data-toggle="modal" data-target="#updateproses"><i class="icon wb-share" aria-hidden="true"></i>Tangani</a></li>
                                    </ul>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <div class="modal fade " tabindex="-1" id="updateproses" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                    ...
                    <div class="modal fade " id="hapusproses" tabindex="-1" role="dialog" aria-hidden="true">
