<template>
    <div class="panel panel-default card-view panel-refresh">
        ...
        <div class="panel-heading">
            <div class="pull-left">
                <h6 class="panel-title txt-dark">Data Complains Selesai</h6>
            </div>
        ...
        <div class="panel-body">
            ...
            <table class="table table-borderless">
                ...
                <tbody>
                    <tr v-for="(kluhan , index) in complain.slice(0,5)" v-bind:key="kluhan._id">
                        <th>{{index + 1}}</th>
                        <th><label class="label label-primary">{{kluhan.complain_penyelesaian}}</label></th>
                                ...
                                <div class="dropdown  pull-left">
                                    ...
                                    <ul class="dropdown-menu bullet dropdown-menu-right" role="menu">
                                        <li role="presentation"><a href="javascript:void(0)" v-on:click="       hapus_pelanggan(
                                                                ...
                                                                )" role="menuitem" data-toggle="modal" data-target=".bs-example-modal-sm"><i class="icon wb-share" aria-hidden="true"></i>Delete</a></li>
                                        <li role="presentation"><a href="javascript:void(0)" v-on:click="detail_pelanggan(
                                                                kluhan._id,
                                                                kluhan.complain_pengguna_nama,
                                                                kluhan.complain_pengguna_alamat,
                                                                kluhan.complain_pengguna_ppoe,
                                                                kluhan.complain_pengguna_keluhan,
                                                                kluhan.complain_penyelesaian,
                                                                kluhan.complain_yang_menangani.complain_penangan_nama,
                                                                kluhan.complain_pengguna_notice)" role="menuitem" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="icon wb-share" aria-hidden="true"></i>Update</a></li>
                                    </ul>
                                </div>
                            </div>
                        </td>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" v-model="complain_pengguna_nama">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="">Alamat</label>
                                                <input type="text" class="form-control" v-model="complain_pengguna_alamat">
                                            </div>
                                            <div class="form-group col-md-4">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control" cols="10" rows="10" v-model="complain_notice"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
