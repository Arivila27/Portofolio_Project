                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">Complain diselesaikan pegawai</h6>
                                </div>
                                    ...
                                    <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" ref="PrintTable" cellpadding="5" border="1" style="font-family: arial, sans-serif;border-collapse: collapse;width: 100%;">
                                        ...
                                        <tbody>
                                            <tr v-for="(pelanggan,index) in FilterPelanggan" :key="pelanggan._id">
                                                <th>{{index + 1}}</th>
                                                <td>{{pelanggan.complain_pengguna_nama}}</td>
                                                <td>Selesai</td>
                                                <td>{{pelanggan.complain_count}}</td>
                                            </tr>
                                        </tbody>
                                        <br>
                                        <br>
...
<script src="./Service/trpenanganan"></script>