    ...
    <div class="panel panel-default card-view panel-refresh">
        ...
        <div class="panel-body">
            ...
            <table class="table table-borderless">
                ...
                <tbody>
                    <tr v-for="(kluhan , index) in DisplayedComplain" v-bind:key="kluhan._id">
                        <th>{{index + 1}}</th>
                            ...
                            <div class="pull-right">
                                <div class="dropdown  pull-left">
                                    ...
                                    <ul class="dropdown-menu bullet dropdown-menu-right" role="menu">
                                        <li role="presentation"><a href="javascript:void(0)" role="menuitem" data-toggle="modal" data-target="#hapus" v-on:click="hereki(kluhan._id,kluhan.complain_status,kluhan.complain_pengguna_nama)"><i class="icon wb-reply" aria-hidden="true"></i>Delete</a></li>
                                        <li role="presentation"><a href="javascript:void(0)" role="menuitem" data-toggle="modal" data-target="#update" v-on:click="detail_pelanggan(kluhan._id,kluhan.complain_pengguna_nama,kluhan.complain_pengguna_alamat,kluhan.complain_pengguna_ppoe,kluhan.complain_pengguna_keluhan,kluhan.complain_penyelesaian,kluhan.complain_pengguna_notice)"><i class="icon wb-share" aria-hidden="true"></i>Tangani</a></li>
                                    </ul>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <div class="modal fade" tabindex="-1" id="update" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <textarea class="form-control" name="" id="" cols="5" rows="5" v-model="complain_pengguna_keluhan"></textarea>
                                            </div>
                                            <div class="form-group col-md-4">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control" v-model="complain_notice" name="" id="" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <multiselect v-model="complain_penangan" tag-placeholder="Add this as new tag" placeholder="Search or add a tag" label="pengguna_nama" track-by="_id" :options="options" :multiple="true" :taggable="true"></multiselect>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal fade " id="hapus" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-danger" v-on:click="deleteds()">Iya</button>
