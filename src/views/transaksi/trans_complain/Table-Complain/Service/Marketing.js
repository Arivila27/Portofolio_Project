...
export default {
    ...
    methods: {
        ...
        getcomplainbelum() {
            axios.get(API + '/Tr_complain/domain/' + this.$store.getters.domain)
                .then((response) => {
                    this.complain = response.data;
                });
        },
        // ----
        // Menghapus data dari data comp[lain]
        deleteds() {
        ...
        // ----
        // MEndapatkan data untuk hapus data 
        hereki(id, stat, nama) {
            this.id = id;
        ...
        detail_pelanggan(id, nama, alamat, ppoe, keluhan, penyelesaian, notice) {
            this.id = id;
            this.complain_pengguna_nama = nama;
        ...
        tangani() {
            ...
            let newcomplain = {
                complain_pengguna_nama: this.complain_pengguna_nama,
