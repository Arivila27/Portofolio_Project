    ...
    <form-wizard @on-complete="addpembelian">
        ...
        <tab-content title="Supplier" icon="ti-user">
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <multiselect v-model="pilih_supplier" :options="M_supplier" :searchable="true" :close-on-select="true" :show-labels="false" label="supplier_nama" placeholder="Pilih Cabang"></multiselect>
                </div>
            </div>
        </tab-content>
        <tab-content title="Detail Pembelian/ Pengiriman" icon="ti-id-badge">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" v-model="noTrans">
            </div>
