                ...
                <div class="panel panel-default card-view" ref="printTable">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <span class="txt-dark head-font inline-block capitalize-font mb-5">{{po.po_pelanggan.pengguna_nama}}</span>
                                    <address class="mb-15">
                                        <span class="address-head mb-5"></span>
                                        {{po.po_pelanggan.pengguna_alamat}} <br>
                                        <abbr></abbr>{{po.po_pelanggan.pengguna_no_telepon}}
                                    </address>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <address>
                                        <span class="txt-dark head-font capitalize-font mb-5">Tanggal po:</span><br>
                                        {{po.po_created}}<br><br>
                                    </address>
                                </div>
                                <div class="col-xs-6 text-right">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 text-right">
                                    <address>
                                        ...
                                        {{po.po_total_transaksi | currency}}<br><br>
                                    </address>
                                </div>
                            </div>
                            <div class="po-bill-table">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr v-for="phi in po.po_transaksi">
                                            ...
                                            <tr class="txt-dark">
                                                ...
                                                <td></td>
                                                <td>Rp.Subtotal</td>
                                                <td>{{po.po_subtotal_transaksi | currency}}</td>
                                            </tr>
                                            <tr class="txt-dark">
                                                <td></td>
                                                <td></td>
                                                <td>PPN</td>
                                                <td>{{po.po_transaksi_ppn | currency}}</td>
                                            </tr>
                                            <tr class="txt-dark">
                                                <td></td>
                                                <td></td>
                                                <td>Total</td>
                                                <td>{{po.po_total_transaksi | currency}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
<script>
    ...
    methods: {
        ...
        getpo() {
            this.$http.get(this.$API + `/Tr_po/${this.$route.params.id}`)
                .then((response) => {
