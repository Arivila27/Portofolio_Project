                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default card-view panel-refresh">
                            ...
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark">MGroup</h6>
                                </div>
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="(mgroup,index) in DisplayedMybitniagaMgroup" v-bind:key="mgroup._id">
                                            <td>{{index + 1}}</td>
                                            <td>{{mgroup.nama_group}}</td>
                                            <td>{{mgroup.logo}}</td>
                                        </tr>
                                    </tbody>
                                </table>
...
<script src="./Service/list_mgroup"></script>