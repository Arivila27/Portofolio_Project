                ...
                <div class="col-md-12">
                    <div class="panel panel-default card-view panel-refresh">
                        ...
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-light">Kode Akun</h6>
                            </div>
                            <div class="pull-right">
                                ...
                                <router-link to="/tambah_kode_akun_real">
...
export default {
    ...
    methods: {
        ...
        deleteds() {
            axios.put(API + `/M_kode_akun_real/${this.kode_akun._id}`, {
                    kode_status: "N",
        ...
        getdata() {
            axios.get(API + '/M_kode_akun_real/' + this.$store.getters.domain)
                .then((response) => {
